                                    ...
                                    <div class="card-body p-md-5">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                                ...
                                                <p class="text-center mb-5 mx-1 mx-md-4 mt-4">DON'T HAVE AN ACCOUNT? <a href="./index.php" class="text-decoration-none">SIGN UP</a></p>
                                                <form class="mx-1 mx-md-4" action="./loginuser.php" method="post">                                                
                                                    ...
                                                    <div class="d-flex flex-row align-items-center mb-4">
                                                        <div class="form-outline flex-fill mb-0">
                                                            <input type="password" name="password" placeholder="Password"id="empPassword" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    <p class="text"><a href="./forgotpassword.php" class="text-decoration-none">Forgot Password?</a></p>
                                                    <div class="d-flex flex-row align-items-center mb-4">
                                                        <div class="form-outline flex-fill mb-0">
                                                            <button type="submit" name="signin" class="form-control btn btn-primary">Login</button>
                                                        </div>
                                                    </div>                                                
                                                </form>                                            
                                            </div>
